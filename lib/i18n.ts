...
export const translations = {
  fr: {
    ...
    auth: {
      ...
      migrationTitle: "Migration manuelle",
      migrationHeading: "Copier les données locales vers le cloud",
      migrationText: "Cette action copie vos données localStorage vers Supabase. Vos données locales restent dans ce navigateur et la synchronisation automatique n'est pas encore activée.",
      localTransactionCount: "Transactions locales disponibles",
      copyLocalToCloud: "Copier mes données locales vers le cloud",
      migrationConfirm: "Copier vos données locales vers Supabase ? Vos données localStorage resteront intactes. Ceci n'active pas encore la synchronisation automatique.",
      migrationSuccess: "{count} transaction(s) copiée(s) vers le cloud. Les doublons sont évités avec l'identifiant local.",
      migrationError: "Impossible de copier les données locales vers le cloud.",
      migrationMissingSession: "Connectez-vous à Supabase avant de copier les données locales."
    },
  ...
  en: {
    ...
    auth: {
      ...
      migrationTitle: "Manual migration",
      migrationHeading: "Copy local data to cloud",
      migrationText: "This copies your localStorage data to Supabase. Your local data stays in this browser and automatic sync is not enabled yet.",
      localTransactionCount: "Local transactions available",
      copyLocalToCloud: "Copy my local data to cloud",
      migrationConfirm: "Copy your local data to Supabase? Your localStorage data will remain untouched. This does not enable automatic sync yet.",
      migrationSuccess: "{count} transaction(s) copied to cloud. Duplicates are prevented with the local ID.",
      migrationError: "Unable to copy local data to cloud.",
      migrationMissingSession: "Sign in to Supabase before copying local data."
    },
